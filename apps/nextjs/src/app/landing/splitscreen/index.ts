// nextjs.md § 7.6 — every token this route added to theme.css and uses here.
// --brand-ink: the plum ground the nav, the hero, and the closing band sit on.
// --brand-ink-foreground: every text colour that reads against --brand-ink.
// --brand-split-a: the first share of a split, and the host who holds it.
// --brand-split-b: the second share of a split, and the co-host who holds it.
